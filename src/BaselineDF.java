...
public class BaselineDF {
	...
	public static void main(String[] args) throws Exception {
		...
		for(int fold=0; fold<folders; fold++) {
			...
			// Main
			String[] a = {"", "", "", Integer.toString(fold+1)};
			Main_BaselineDiffusionCV.main(a);
			
			// AUC
			auc = Main_BaselineDiffusionCV.getAucAll();
			aucSD = Main_BaselineDiffusionCV.getAucSDAll();
			aucCI = Main_BaselineDiffusionCV.getAucCIAll();
			aucAll += auc;
